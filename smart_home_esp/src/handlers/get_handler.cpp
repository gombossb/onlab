...
String gettableDevices[NUM_GETTABLE] = {"LED_CAR", "LED_1", "LED_2", "LED_3", "TMP_1", "TMP_2", "TMP_3", "PHOTO_RES", "FAN_1", "FAN_2", "HEATING", "SERVO_BLINDS"};
...
String getHandler(String device){
    ...
    } else if (device == "PHOTO_RES"){
        uint32_t reading = analogRead(photoResPin);
        data = String(reading);
